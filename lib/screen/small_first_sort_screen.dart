...
class SmallFirstSortScreen extends StatelessWidget {
  const SmallFirstSortScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('ငယ်စဉ်ကြီးလိုက် ပဟေဠိ'),
        centerTitle: true,
      ),
      body: const Body(),
    );
    ...
    return Container(
      ...
      child: Center(
        child: Column(
          children: [
            const Text(
              'ငယ်သောကိန်းမှကြီးသောကိန်းသို့ စီပေးပါ။',
              style: TextStyle(
                fontSize: 25,
